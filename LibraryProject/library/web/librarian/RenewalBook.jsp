...
<html>
    ...
    <body>
        ...
        <div class="form-wrapper">
            ...
            <h3 class="form-title">Renew Book</h3>
            <form action="RenewalBook1.jsp" method="post">
                <input type="hidden" name="pageName" value="RenewalBook.jsp">
                ...
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" name="dor">
                </div>
