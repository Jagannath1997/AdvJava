...
<html>
    <head>
        <title>Online Library | Teacher Registration :: library</title>
        <!-- custom-theme -->
    ...
    <body>
        ...
        <div class="form-wrapper">
            ...
            <h3 class="form-title">New Teacher Registration</h3>
            <form action="TeacherRegister1.jsp" method="post">
                <input type="hidden" name="pageName" value="TeacherRegister.jsp">
                ...
                <a href="../login.jsp" class="pull-right">Already Registered ?</a>
            </form>
        </div>
