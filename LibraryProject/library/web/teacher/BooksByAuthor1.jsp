...
<%
    String bookAuthor = request.getParameter("bookAuthor").toLowerCase();
    Connection con = DBConn.getConn();
    PreparedStatement ps = con.prepareStatement("select * from books WHERE LOWER(AUTHOR) LIKE '%" + bookAuthor + "%'");
    ...
    <body>
        ...
        <div class="container" style="margin-top: 50px; padding-bottom: 50px;">
            <div class="table-responsive">
                ...
                <a href="BooksByAuthor.jsp" class="btn btn-danger">Back</a>
            </div>
        </div>
