...
<html>
    <head>
        <title>Online Library | Home :: library</title>
        <!-- custom-theme -->
    ...
    <body>
        ...
        <div class="about-agileits">
            <div class="container">	
                ...
                <div class="agileits_banner_bottom">
                    <p>It is rightly said, "Knowledge is Power". Knowledge achieved from reading Books. Hence LIBRARY is an area where collection of books is done. Therefore Library is one of the most key components of an education Institution. An excellent Library, stocked with varied reference books from basics to advanced study helps the Students to enrich their knowledge.</p>
                </div>
                    ...
                    <ul class="cbp-ig-grid">
                        <li>
                            <div class="w3_grid_effect">
                                ...
                                <span class="cbp-ig-category">E Library</span>
                            </div>
                        </li>
                        <li>
                            <div class="w3_grid_effect">
        ...
        <div class="stats-agileits" id="stats">
            <div class="container">
                <h3 class="heading-agileinfo white-w3ls">We Have Something To Be Proud Of<span class="black-w3ls">The following is our statistics.</span></h3>
            </div>
            ...
            <div class="popular-grids">
                <div class="col-md-3 popular-grid">
                    ...
                    <div class="popular-text">
                        <h5><a href="#" data-toggle="modal" data-target="#myModal2">Emphasize Summer 2018</a></h5>
                        <div class="detail-bottom">
                            <ul>
                                <li><i class="fa fa-calendar" aria-hidden="true"></i>30 May</li>
                                <li><i class="fa fa-map-marker" aria-hidden="true"></i>LONDON, UK</li>
                ...
                <div class="col-md-3 popular-grid">
                    ...
                    <div class="popular-text">
                        <h5><a href="#" data-toggle="modal" data-target="#myModal4">Education tour 2018</a></h5>
                        <div class="detail-bottom">
                            <ul>
                                <li><i class="fa fa-calendar" aria-hidden="true"></i>25June</li>
                                <li><i class="fa fa-map-marker" aria-hidden="true"></i>VENICE, ITALY</li>
        ...
        <div id="testimonials" class="testimonials">
            <div class="container">
                <h3 class="heading-agileinfo">Our Partners Says<span>What our customers says about us.</span></h3>
