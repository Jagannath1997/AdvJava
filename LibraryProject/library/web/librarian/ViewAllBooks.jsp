                ...
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="UpdateBook.jsp?bookID=<%=rs.getString("BOOKID")%>" class="btn btn-primary">Update</a>
                                <a href="DeleteBook.jsp?bookID=<%=rs.getString("BOOKID")%>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                        <%
                            }
