...
<html>
    <head>
        <title>Online Library | Login :: library</title>
        <!-- custom-theme -->
    ...
    <body>
        ...
        <div class="form-wrapper">
            ...
            <form action="login1.jsp" method="post">
                ...
                <a href="StudentRegister.jsp" class="pull-right">Not Registered ?</a>
                <a href="ForgotPassword.jsp" class="pull-right" style="margin-right: 30px;">Forgot Password ?</a>
            </form>
        </div>
