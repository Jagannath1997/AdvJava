...
<%
    ...
    PreparedStatement ps = con.prepareStatement("select * from librarian WHERE userid=?");
...
<html>
    ...
    <body>
        ...
        <div class="form-wrapper">
            ...
            <h3 class="form-title">Update Librarian</h3>
            <form action="UpdateLibrarian1.jsp" method="post">
                <input type="hidden" name="pageName" value="UpdateLibrarian.jsp">
