...
<html>
    ...
    <body>
        ...
        <div id="home" class="banner inner-banner-w3l">
            <%@include file="TeacherNavigation.jsp"%>
        </div>	
        <!-- //Header -->

        <div class="form-wrapper">
            <%@include file="../msg.jsp"%>
            <h3 class="form-title">Reserve Book</h3>
            <form action="ReserveBook1.jsp" method="post">
                <input type="hidden" name="pageName" value="ReserveBook.jsp">
                ...
                <div class="form-group">
                    <label>Date of Reserve</label>
                    <input type="text" class="form-control" name="dateofreserve">
                </div>
