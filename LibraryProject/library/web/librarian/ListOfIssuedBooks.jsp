...
<%
    ...
    PreparedStatement pstmt = con.prepareStatement("select * from issue");
    ...
    <body>
        ...
        <div class="container" style="margin-top: 50px; padding-bottom: 50px;">
            <div class="table-responsive">
                <h3 style="color: #0066ff; margin-bottom: 10px;">List of Issued Books</h3>
