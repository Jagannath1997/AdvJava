...
<html>
    <head>
        <title>Online Library | Student Registration :: library</title>
        <!-- custom-theme -->
    ...
    <body>
        ...
        <div class="form-wrapper">
            ...
            <form action="StudentRegister1.jsp" method="post">
                <input type="hidden" name="pageName" value="StudentRegister.jsp">
