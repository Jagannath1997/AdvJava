...
<%
    ...
    PreparedStatement pstmt = con.prepareStatement("select * from renewals");
    ...
    <body>
        ...
        <div class="container" style="margin-top: 50px; padding-bottom: 50px;">
            <div class="table-responsive">
                <h3 style="color: #0066ff; margin-bottom: 10px;">List of Renewal Books</h3>
                <table class="table table-bordered table-hover">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><%=rs.getString("DATEOFRENEWAL")%></td>
                        </tr>
                        <%
                            }
                        %>
